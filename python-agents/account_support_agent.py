...
MOCK_IDENTIFIERS = {
    ...
    # IBANs
    "US12345678901234567890": "CUST001",
    "US09876543210987654321": "CUST002",
    "US55566677788899001122": "CUST003",
...
MOCK_PRODUCTS = {
    "CUST001": [
        {"product_id": "CHK001", "type": "checking_account", "status": "active", "balance": 2500.00},
        {"product_id": "CC001", "type": "credit_card", "status": "active", "limit": 5000.00},
        {"product_id": "SAV001", "type": "savings_account", "status": "active", "balance": 15000.00}
    ],
    "CUST002": [
        {"product_id": "CHK002", "type": "checking_account", "status": "active", "balance": 1200.00},
        {"product_id": "LON001", "type": "personal_loan", "status": "active", "principal": 10000.00}
    ],
    "CUST003": [
        {"product_id": "CHK003", "type": "checking_account", "status": "frozen", "balance": 3200.00},
        {"product_id": "CC003", "type": "credit_card", "status": "active", "limit": 10000.00},
        {"product_id": "SAV003", "type": "savings_account", "status": "active", "balance": 25000.00},
        {"product_id": "MTG001", "type": "mortgage", "status": "active", "principal": 250000.00}
    ]
}
...
def search_customer(identifier: str) -> Dict[str, Any]:
    """Search for customer by account number, IBAN, or card number"""
    ...
    "search_customer": (
        lambda args: search_customer(args.get("identifier", "")),
        {
            ...
            "properties": {
                "identifier": {
                    "type": "string", 
                    "description": "Customer identifier: account number, IBAN, or card number"
                }
            },
            "required": ["identifier"]
        }
